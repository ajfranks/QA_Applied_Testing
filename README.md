...
<img width="980" height="500" alt="CleanShot 2025-12-14 at 12 43 10@2x" src="https://github.com/user-attachments/assets/2e15b69e-489c-4692-9b23-cf74fb90463e" />

## Project Overview
This project focuses on testing the Urban Scooter application, including web, mobile, and backend (API) components. The goal of this was to validate core functionality, identify defects, and ensure the application meets all requirements within the limited testing timeframe. 

## Project Scope 
The project was divided into three main testing tasks, each targeting a different layer of the application:
